...
public class TestChangedIterationReading {
   ...
   private final static File DATA_FOLDER = new File("src/test/resources/dataReading/changedIterations");
   ...
   public void testChangedIterationReading() throws InterruptedException {
      ...
      AnalyseFullData afd = new AnalyseFullData(new File("target/changes.json"), statistics, null);
