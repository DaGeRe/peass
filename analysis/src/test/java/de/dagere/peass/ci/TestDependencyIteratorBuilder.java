...
public class TestDependencyIteratorBuilder {
   ...
   public void testRegularIteratorCreation() {
      try (MockedStatic<GitUtils> gitUtil = Mockito.mockStatic(GitUtils.class)) {
         ...
         StaticalTestSelection dependencies = buildVersionDependencies(LAST_RUNNING_VERSION);
   ...
   public void testNightlyBuildWithoutPrePredecessor() {
      try (MockedStatic<GitUtils> gitUtil = Mockito.mockStatic(GitUtils.class)) {
         ...
         StaticalTestSelection dependencies = buildVersionDependencies();
   ...
   public void testNightlyBuildWithoutRunningPrePredecessor() {
      try (MockedStatic<GitUtils> gitUtil = Mockito.mockStatic(GitUtils.class)) {
         ...
         StaticalTestSelection dependencies = buildVersionDependencies(SIMPLE_PREDECESSOR);
   ...
   public void testNightlyBuildWithPrePredecessor() {
      try (MockedStatic<GitUtils> gitUtil = Mockito.mockStatic(GitUtils.class)) {
         ...
         StaticalTestSelection dependencies = buildVersionDependencies(SIMPLE_PREDECESSOR, VERSION_2);
   ...
   private StaticalTestSelection buildVersionDependencies(final String... versionNames) {
