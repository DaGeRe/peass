...
public class DependencyIteratorBuilder {
   ...
   public DependencyIteratorBuilder(final ExecutionConfig executionConfig, final StaticalTestSelection dependencies, final PeassFolders folders) {
   ...
   private String getPrePredecessor(final StaticalTestSelection dependencies) {
