...
public class TestSourceDetection {
	...
	public void testAnonymousClazzes() throws ParseException, IOException{
		...
		final TraceElementContent currentTraceElement = new TraceElementContent("Test1_Anonym$1", "<init>", 1);
		...
		final TraceElementContent traceElementRun1 = new TraceElementContent("Test1_Anonym$1", "run", 1);
		...
		final TraceElementContent traceElementRun2 = new TraceElementContent("Test1_Anonym$2", "run", 1);
		...
		final TraceElementContent traceElementRun3 = new TraceElementContent("Test1_Anonym$3", "run", 1);
	...
	public void testNamedClazzes() throws ParseException, IOException{
		...
		final TraceElementContent currentTraceElement = new TraceElementContent("Test2_Named$MyStuff", "doMyStuff1", 1);
		...
		final TraceElementContent currentTraceElement2 = new TraceElementContent("Test2_Named$MyStuff2", "doMyStuff2", 1);
	...
	public void testNamedList() throws FileNotFoundException{
		final File file = new File(SOURCE, "Test2_Named.java");
		final CompilationUnit cu = JavaParser.parse(file);
		final Map<String, ClassOrInterfaceDeclaration> named = TraceReadUtils.getNamedClasses(cu);
