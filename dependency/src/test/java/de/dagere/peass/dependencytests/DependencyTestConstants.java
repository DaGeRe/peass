...
public class DependencyTestConstants {
   ...
   public static final TestSelectionConfig DEFAULT_CONFIG_NO_VIEWS = new TestSelectionConfig(1, false, false, false, false, true);
   public static final TestSelectionConfig DEFAULT_CONFIG_WITH_VIEWS = new TestSelectionConfig(1, false, true, false, false, true);
   public static final TestSelectionConfig DEFAULT_CONFIG_WITH_COVERAGE = new TestSelectionConfig(1, false, true, true, false, true);
