...
public class DependencyDetectorMultimoduleIT {
   ...
   public void testNormalChange() throws IOException, InterruptedException, XmlPullParserException, ParseException, ViewNotFoundException {
      ...
      StaticalTestSelection dependencies = reader.getDependencies();
   ...
   private void checkInitialVersion(final StaticalTestSelection dependencies) {
   ...
   private void testSecondChange(final StaticalTestSelection dependencies) {
   ...
   private void testFirstChange(final StaticalTestSelection dependencies) {
