...
public class TestVersionSplitting {
   ...
   public void testSplittingNonRunning() throws IOException {
      ...
      for (int i = 1; i < 10; i++) {
         for (int j = i + 1; j < 10; j++) {
            ...
            List<StaticalTestSelection> dependencies = new LinkedList<>();
            ...
            StaticalTestSelection merged = PartialDependenciesMerger.mergeDependencies(dependencies);
   ...
   public void testEmptyMerging() {
      StaticalTestSelection merged = PartialDependenciesMerger.mergeDependencies(new LinkedList<>());
   ...
   private void readUntilMax(final List<GitCommit> commits, final List<StaticalTestSelection> dependencies, final int i, final int min, final int max) throws IOException {
   ...
   private void readDummyDependencies(final List<StaticalTestSelection> dependencies, final int i, final List<GitCommit> currentCommits, final List<GitCommit> reserveCommits,
