...
//      File logFile = new File(folders.getLogFolder(), "test.txt");
      ...
      for (String val : new String[] {"-val1", "-val2"}) {
         Kopemedata data = XMLDataLoader.loadData(new File(clazzFolder, testcase.getMethod() + val + ".xml"));
         ...
         Assert.assertEquals("testMethod" + val, testcaseData.getName());
