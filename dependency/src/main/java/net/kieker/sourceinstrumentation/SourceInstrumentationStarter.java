...
public class SourceInstrumentationStarter implements Callable<Integer>{
   ...
   public Integer call() throws Exception {
      ...
      final InstrumentationConfiguration configuration = new InstrumentationConfiguration(AllowedKiekerRecord.REDUCED_OPERATIONEXECUTION, true, includedPatterns, false, true);
