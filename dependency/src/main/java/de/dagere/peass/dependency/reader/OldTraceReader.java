...
public class OldTraceReader {
   ...
   private final StaticalTestSelection dependencyResult;
   private final ResultsFolders resultsFolders;
   
   public OldTraceReader(final TraceFileMapping traceFileMapping, final StaticalTestSelection dependencyResult, final ResultsFolders resultsFolders) {
