...
public class PerAnFilter extends AbstractFilterPlugin {
	...
	public PerAnFilter(final String prefix, final Configuration configuration, final IProjectContext projectContext) {
...
//					System.out.println(execution);
					...
					if (!methodname.equals("logFullData") && !methodname.equals("useKieker")) {
