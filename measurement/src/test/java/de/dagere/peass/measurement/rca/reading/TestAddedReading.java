...
public class TestAddedReading {
   ...
   private Set<CallTreeNode> buildTree() {
      ...
      includedNodes.add(root.appendChild("A.child3()", "public void A.child3()", "ADDED"));
   ...
   public void testReading() throws AnalysisConfigurationException, JsonParseException, JsonMappingException, IOException {
      ...
      final KiekerResultReader reader = new KiekerResultReader(false, AllowedKiekerRecord.OPERATIONEXECUTION, RCAStrategy.COMPLETE, includedNodes, "0", testcase, false);
