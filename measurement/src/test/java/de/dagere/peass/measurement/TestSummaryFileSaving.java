...
public class TestSummaryFileSaving {
   ...
   public void testSummaryFileSaving() {
      ...
      MultipleVMTestUtil.saveSummaryData(resultFile, oneResultFile, oneRunData.getDatacollectorResults().get(0).getResults().get(0), testcase, "1", 0,
            TimeDataCollector.class.getName());
   ...
   public void testSummaryFileSavingWithModule() {
      TestMethodCall testcase = new TestMethodCall("myPackage.Test", "test", "myModule");
      DummyKoPeMeDataCreator.initDummyTestfile(testFolder, TestResult.BOUNDARY_SAVE_FILE * 2, testcase);
